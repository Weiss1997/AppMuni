...
exports.getTheme = function (name) {
    var themes = {
		'striped': {
			...
			header: { textColor: 255, fillColor: [169, 204, 227], fontStyle: 'bold' },
			body: { textColor: 0, fontSize: 7, fillColor: [242, 244, 244], fontStyle: 'normal' },
			alternateRow: { fillColor: [204, 209, 209 ] }
        },
        'grid': {
            table: { fillColor: 255, textColor: 80, fontStyle: 'normal', lineWidth: 0.1 },
